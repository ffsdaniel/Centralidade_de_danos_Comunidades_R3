...
map.getView().fit([480887.950174, 7778896.900998, 646024.637959, 7896582.185526], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Comunidades da Região 3 - Categorias de danos </h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_Categorias_Danos_populacao_distanciasarquivo_de_sada_3,
    colName: 'Comunidade',
    zoom: 10,
    collapsed: true,
    map: map
